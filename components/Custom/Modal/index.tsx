    ...
    <Transition show={props.open} as={Fragment}>
      <Dialog {...props} className='fixed inset-0 z-40 text-primary '>
        ...
        <Transition.Child
          ...
          className={[
            'fixed z-40 w-full h-full overflow-y-auto origin-center transform -translate-x-1/2 -translate-y-1/2 md:w-3/4 md:h-5/6 inset-1/2 scrollbar-hide rounded-xl',
            sizeClass
          ]
            .join(' ')
            .trim()}
