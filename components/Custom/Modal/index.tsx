...
const Modal = ({
  ...
  if (size === 'xl') {
    sizeClass = 'max-w-max'
    baseClass = 'fixed z-40 w-full h-full overflow-y-auto origin-center transform -translate-x-1/2 -translate-y-1/2 md:w-3/4 lg:w-3/4 inset-1/2 mt-20';
    ...
    <Transition show={props.open} as={Fragment}>
      <Dialog {...props} className='fixed inset-0 z-40 text-primary'>
        ...
        <Transition.Child
          ...
          className={[baseClass, sizeClass].join(' ').trim()}
        >
