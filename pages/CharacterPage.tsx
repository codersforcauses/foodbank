    ...
    return (
        ...
        <>
            ...
            <div className=' flex items-center justify-center h-screen w-screen'>
                <div className='relative w-1/3 h-1/3 z-20'>
                ...
                <div className='relative w-128 h-max ml-20 flex flex-col justify-center items-center bg-grey-light z-20 rounded-3xl font-serif'>
                    <div className='absolute inline-flex flex-col -top-16 gap-4'>
                        <div className='border-t-4 border-l-4 border-r-12 border-b-4 border-black top-0 relative h-16 w-72 text-3xl bottom-10 bg-primary flex justify-center items-center text-white uppercase transform rotate-6 z-10 p-2 left-16'>Everyday Food</div>
                        <div className=' border-t-4 border-l-4 border-r-12 border-b-4 border-black -top-4 relative h-16 w-72 text-3xl bg-orange flex justify-center items-center text-white uppercase transform -rotate-6 p-2'>Character Name </div>
                    </div>
